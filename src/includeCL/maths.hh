...
{
public:
  enum ANGLECL_TYPE {DEG, RAD, INVALID}; ///<The type of angle the class can handle. DEG and RAD are self-expalantory, while INVALID is used as a flag in case of problems.
...
public:
  ...
  */
  Angle(double _th, ANGLECL_TYPE _type=RAD) : type(_type), th(_th){ 
    normalize();
  }
  ...
  ANGLECL_TYPE getType () const { return type; }///<Returns the type of the angle.
  ...
  */
  void setType (ANGLECL_TYPE _type) { type=_type; normalize(); } 
